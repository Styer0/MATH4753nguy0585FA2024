#' @title Boostrap Confidence Interval Function
#'
#' @description
#' Computes bootstrap confidence intervals and visualizes the distribution of sample statistics.
#'
#' @param iter Number of Iterations (default: 10000)
#' @param x Sample data for bootstrapping
...
#' @param ... Additional graphical parameters for histogram
#'
#' @return A list with confidence interval (`ci`), function used (`fun`), and input data (`x`)
#' @export
#'
#' @examples
