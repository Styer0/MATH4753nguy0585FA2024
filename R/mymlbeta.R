#' @title Maximum Likelihood Estimation for Beta Distribution
#'
#' @description
#' Computes the maximum likelihood estimates of alpha and beta parameters
#' for a given sample vector.
#'
#' @param x Numeric vector representing the sample data.
#' @param alpha Numeric vector of alpha values to evaluate.
#' @param beta Numeric vector of beta values to evaluate.
#' @param ... Additional graphical parameters for contour plot.
#'
#' @return A list with sample vector (`x`), coordinates of max likelihood,
#'   max likelihood value (`maxl`), and estimated alpha (`maxalpha`)
#'   and beta (`maxbeta`).
#' @export
#'
#' @examples
